...
export default defineConfig(({ mode }) => {
  ...
  // subpath the app is served from (e.g. "/draw/" for a GitHub Pages project site)
  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Cornerdraw",
          name: "Cornerdraw",
          description:
            "Cornerdraw is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
